...
import {AppString} from './../Const'
 ...
 class ChatBoard  extends Component {
    ...
    getListHistory = () => {
        ...
        // console.log(this.groupChatId+this.currentPeerUser.id);
        let var1=this.groupChatId+this.currentPeerUser.id;
         this.setState({lastseenme:var1});
         // console.log(this.state.lastseenme);
        // localStorage.setItem(lastseenme,timestamp);
    ...
    onSendMessage = (content, type) => {
        ...
        let lasTseenme=this.groupChatId+this.currentUserId;
        localStorage.setItem(lasTseenme,timestamp);
        // console.log(lasTseenme);
        //   console.log(localStorage.getItem(lasTseenme));
        myFirestore
            .collection(AppString.NODE_MESSAGES)
            .doc(this.groupChatId)
            .collection(this.groupChatId)
            ...
            <div className="viewChatBoard">
                ...
                <div className="headerChatBoard">
                    ...
                    />
                          ...
                          <Link to="/video-chat" target="blank" className="video">
                          <img  src={require('../../images/video.png')} className="video" alt="video-call"   >
                          </img>
                          </Link>
                ...
                <div className="viewBottom">
                    ...
                    <textarea
                        ...
                        value={this.state.inputValue.replace('\\n','\n')}
                        onChange={event => {
        ...
        if (this.listMessage.length > 0) {
            ...
            this.listMessage.forEach((item, index) => {
                if (item.idFrom === this.currentUserId) {
                    ...
                    if (item.type === 0) {
                        viewListMessage.push(
                            <div className="viewItemRight" key={item.timestamp}>
                                <div className="textContentItem">{item.content}</div>
                    ...
                    localStorage.setItem(this.state.lastseenme,item.timestamp);
                    // console.log(this.lastseenme);
                    if (item.type === 0) {
                        viewListMessage.push(
            ...
            return (
                <div className="viewWrapSayHi">
                    <span className="textSayHi">Say hi to {this.currentPeerUser.nickname}</span>
                    <img
